   ...
   $(document).ready(function(){
        ...
        $(".post-link").click(function(){
			  var post_link = $(this).attr("href");
				alert("<?php echo wp_make_link_relative("http://www.smgoodrich.com/Blog/uncategorized/stuff-i-need/")?>");
            $("#single-post-container").html("content loading");
            $("#single-post-container").load("/Blog/uncategorized/stuff-i-need");
...
<div id="menu">
  ...
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
    ...
    <a class="post-link" rel="<?php the_ID(); ?>" href="<?php  get_page_link(); ?>">
       <?php the_title(); ?> 
    ...
    <?php endwhile; endif; ?>
                       	...
                       	<div id="single-post-container" style="width:50%; height:50%; background-color:white;"></div>
